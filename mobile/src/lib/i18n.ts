...
const D: Record<string, E> = {
  ...
  // --- fréttaveita
  "HVERJIR SJÁ": ["WHO CAN SEE", "AI CÓ THỂ XEM"], "Allir": ["Everyone", "Mọi người"], "Birtist hjá {x}{y}": ["Visible to {x}{y}", "Hiển thị với {x}{y}"], " og þau fá push-tilkynningu": [" and they get a push notification", " và họ nhận thông báo đẩy"], "Aðeins stjórnendur mega birta í fréttaveituna": ["Only managers can post to the newsfeed", "Chỉ quản lý mới được đăng lên bảng tin"], "Stjórnendur og vaktstjórar birta í fréttaveituna. Þú getur brugðist við og skrifað athugasemdir.": ["Managers post to the newsfeed. You can react and comment.", "Quản lý đăng bài lên bảng tin. Bạn có thể bày tỏ cảm xúc và bình luận."],
