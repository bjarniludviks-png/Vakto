...
const T: Record<Lang, {
  ...
  is: {
    ...
    steps: [
      { title: "Stofnaðu aðgang", desc: "Fyrirtækið, fólkið (lesið inn úr Excel) og kjarasamningarnir — inn á korteri. Kortið skráð, ekkert dregið í 14 daga." },
  ...
  en: {
    ...
    steps: [
      { title: "Create your account", desc: "Your company, your people (imported from Excel) and your agreements — set up in fifteen minutes. Card on file, nothing charged for 14 days." },
