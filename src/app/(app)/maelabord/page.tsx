...
export default async function MaelabordPage() {
  ...
  return <DashboardScreen laborPct={view.laborPct} laborCostWeek={view.laborCostWeek} hoursWeek={view.hoursWeek} onboarding={view.onboarding} live={view.live} onNow={board.rows} missing={board.missing} />;
}
