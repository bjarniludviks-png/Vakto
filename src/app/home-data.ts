...
export const I18N = {
  is: {
    nav_features: "Eiginleikar", nav_how: "Hvernig það virkar", nav_integrations: "Tengingar", nav_pricing: "Verð", nav_login: "Innskráning", nav_try: "Byrja núna",
  ...
  en: {
    ...
    hero_title: 'The simplest scheduling & time-tracking system <span class="g">everyone loves</span>.',
...
export const PCTA: Record<Lang, string> = { is: "Byrja núna", en: "Get started" };
